...
II. Part II - Environment Setup (*coming soon*)  
...
lbl401cb:
  ...
  input = (uint32_t *)param_1->data;
                    /* input[1] is an offset/account number */
  if (0x280 < input[1]) {
...
In Part II of this series (*coming soon*), we will look at setting up a test environment with some debug logging and deploying our very own smart-contract.
